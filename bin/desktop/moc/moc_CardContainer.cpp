...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_CardContainer_t, stringdata0) + ofs \
...
void CardContainer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (CardContainer::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&CardContainer::clicked)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject CardContainer::staticMetaObject = {
    { &QLabel::staticMetaObject, qt_meta_stringdata_CardContainer.data,
...
void *CardContainer::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CardContainer.stringdata0))
