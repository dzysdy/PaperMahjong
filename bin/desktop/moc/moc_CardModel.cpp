...
void CardModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        CardModel *_t = static_cast<CardModel *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (CardModel::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&CardModel::updated)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject CardModel::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_CardModel.data,
      qt_meta_data_CardModel,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *CardModel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CardModel.stringdata0))
        return static_cast<void*>(const_cast< CardModel*>(this));
